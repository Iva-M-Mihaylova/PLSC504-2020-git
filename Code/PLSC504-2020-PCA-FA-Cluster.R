...
pdf("PCA-scores-scatterplot.pdf",6,6)
par(mar=c(4,4,2,2))
...
pdf("PCA-sim-scattermatrix.pdf",7,6)
...
pdf("FA-loadings-scattermatrix.pdf",7,6)
...
url <- getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2020-git/master/Data/ANES2016.csv")
...
pdf("SimulatedScreePlot.pdf",7,6)
FAP <- fa.parallel(df)
dev.off()
...
url <- getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2020-git/master/Data/SCOTUS-IRT.csv")
...
url <- getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2020-git/master/Data/States2005.csv")
