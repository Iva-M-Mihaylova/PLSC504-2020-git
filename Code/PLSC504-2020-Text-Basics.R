...
# need to download them from the github repo 
# and fix the directory paths in the 
# following code to make it work.
...
pdf("Notes/ClintonCorrs.pdf",6,5)
par(mar=c(4,4,2,2))
...
pdf("Notes/D16-TDM-plot.pdf",6,5)
...
pdf("Notes/D16-TFIDF-plot.pdf",6,5)
