...
library(texreg)
library(lmtest)
library(zoo) # install as needed
library(tseries) # install as needed
library(forecast) # install as needed
library(dyn) # install as needed
library(egcm) # install as needed
library(urca) # install as needed
...
url <- getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2020-git/master/Data/DCongPct.csv")
...
url <- getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2020-git/master/Data/CongressVotes.csv")
...
url <- getURL("https://raw.githubusercontent.com/PrisonRodeo/PLSC504-2020-git/master/Data/Mustangs.csv")
